...
<body style="margin-left: 30px;">
    ...
    <p>These terms and conditions outline the rules and regulations for the use of WiseText's Website</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use WiseText if you do not
    ...
    <p>We employ the use of cookies. By accessing WiseText, you agreed to use cookies in agreement with the WiseText's Privacy
        Policy. </p>
    ...
    <p>Unless otherwise stated, WiseText and/or its licensors own the intellectual property rights for all material on WiseText. All
        intellectual property rights are reserved. You may access this from WiseText for your own personal use subjected to
        restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from WiseText</li>
        <li>Sell, rent or sub-license material from WiseText</li>
        <li>Reproduce, duplicate or copy material from WiseText</li>
        <li>Redistribute content from WiseText</li>
    </ul>
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
        of the website. WiseText does not filter, edit, publish or review Comments prior to their presence on the website.
        Comments do not reflect the views and opinions of WiseText,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by applicable laws, WiseText shall not
    ...
    <p>WiseText reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate,
    ...
    <p>You hereby grant WiseText a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of WiseText; and (d) the
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to WiseText. Please include your name, your organization name, contact information
    ...
    <p>No use of WiseText's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
